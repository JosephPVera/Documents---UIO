...
reason has to be a funtion of possition and parameter alpha
...
class LocalEnergy(State):
        ...
        '''
        ===============================================================================
        Anlytic local energy, it is funtion of the position and parameter alpha
        ...
        '''
        ===============================================================================
        Numerical calculation of the local energy using jax packes, it is funtion of 
        position and paramer alpha

        Note: The wave funtion it is a ln(wavefuntion)
        ...
        def local_energy_num(self,
            ...
            Hessian_ln_wave_funtion = jax.hessian(super().ln_wave_funtion,argnums = 0)
            ...
            for i in range(self.Number_particles):
                ...
                # Laplacian 
                Evaluated_hessian = Hessian_ln_wave_funtion(r[i,:], alpha) 
